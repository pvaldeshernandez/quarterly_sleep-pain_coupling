...
Input:  derivatives/step2_processed_long.csv
        derivatives/step8_ps_fmri_roi_values.csv
        derivatives/step8_ps_vbm_roi_values.csv
Output:
  derivatives/
    step9_ps_fmri_posterior_draws.npz
    step9_ps_vbm_posterior_draws.npz
  results/
...
IN_FMRI_CSV = os.path.join(DERIV_DIR, "step8_ps_fmri_roi_values.csv")
IN_VBM_CSV = os.path.join(DERIV_DIR, "step8_ps_vbm_roi_values.csv")

OUT_FMRI_DRAWS = os.path.join(DERIV_DIR, "step9_ps_fmri_posterior_draws.npz")
OUT_VBM_DRAWS = os.path.join(DERIV_DIR, "step9_ps_vbm_posterior_draws.npz")
OUT_FMRI_TABLE = os.path.join(RESULTS_DIR, "step9_table_s1_fmri_arousal.csv")
OUT_VBM_TABLE = os.path.join(RESULTS_DIR, "step9_table_s1_vbm_arousal.csv")
OUT_VBM_SIGN = os.path.join(RESULTS_DIR, "step9_vbm_sign_concordance.csv")
