...
Input:  derivatives/step9_ps_fmri_posterior_draws.npz
        derivatives/step9_ps_vbm_posterior_draws.npz
        results/step9_table_s1_fmri_arousal.csv
        results/step9_table_s1_vbm_arousal.csv
Output:
  derivatives/
    step10_jn_ps_fmri_results.csv
    step10_jn_ps_vbm_results.csv
  results/
    step10_figure_s7_fmri_arousal_jn.png   — Figure S7
    step10_figure_s8_vbm_arousal_jn.png    — Figure S8
...
IN_FMRI_DRAWS = os.path.join(DERIV_DIR, "step9_ps_fmri_posterior_draws.npz")
IN_VBM_DRAWS = os.path.join(DERIV_DIR, "step9_ps_vbm_posterior_draws.npz")
IN_FMRI_TABLE = os.path.join(RESULTS_DIR, "step9_table_s1_fmri_arousal.csv")
IN_VBM_TABLE = os.path.join(RESULTS_DIR, "step9_table_s1_vbm_arousal.csv")

OUT_FMRI_JN = os.path.join(DERIV_DIR, "step10_jn_ps_fmri_results.csv")
OUT_VBM_JN = os.path.join(DERIV_DIR, "step10_jn_ps_vbm_results.csv")
OUT_FIG_S7 = os.path.join(RESULTS_DIR, "step10_figure_s7_fmri_arousal_jn.png")
OUT_FIG_S8 = os.path.join(RESULTS_DIR, "step10_figure_s8_vbm_arousal_jn.png")
