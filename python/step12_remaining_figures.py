...
OUT_FIG2 = os.path.join(RESULTS_DIR, "step12_figure2_ps_coupling.png")
OUT_FIG3 = os.path.join(RESULTS_DIR, "step12_figure3_sp_coupling.png")
OUT_FIG_S1 = os.path.join(RESULTS_DIR, "step12_figure_s1_endorsement.png")
OUT_FIG_S2 = os.path.join(RESULTS_DIR, "step12_figure_s2_convergent.png")
