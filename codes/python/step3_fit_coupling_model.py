...
# Derivatives
OUT_DRAWS_NPZ = os.path.join(STEP_DERIV_DIR, "step3_posterior_draws.npz")
OUT_PERSON_CSV = os.path.join(STEP_DERIV_DIR, "step3_person_coupling.csv")

# Results
OUT_TABLE4_CSV = os.path.join(STEP_RESULTS_DIR, "step3_table4_coupling.csv")
OUT_LOO_CSV = os.path.join(STEP_RESULTS_DIR, "step3_loo_comparison.csv")
