...
STEP_DERIV_DIR = os.path.join(DERIV_DIR, "step9")
...
OUT_FMRI_CSV = os.path.join(STEP_DERIV_DIR, "step9_ps_fmri_roi_values.csv")
OUT_VBM_CSV = os.path.join(STEP_DERIV_DIR, "step9_ps_vbm_roi_values.csv")
