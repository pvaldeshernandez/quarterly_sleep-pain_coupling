...
Input:  derivatives/step19/step19_ps_fmri_posterior_draws.npz
        derivatives/step19/step19_ps_vbm_posterior_draws.npz
        results/step19/step19_table_s1_fmri_arousal.csv
        results/step19/step19_table_s1_vbm_arousal.csv
Output:
  derivatives/step20/
...
STEP_DERIV_DIR = os.path.join(DERIV_DIR, "step20_ps_jn")
os.makedirs(STEP_DERIV_DIR, exist_ok=True)
RESULTS_DIR = os.path.join(ROOT, "results")
STEP_RESULTS_DIR = os.path.join(RESULTS_DIR, "step20_ps_jn")
os.makedirs(STEP_RESULTS_DIR, exist_ok=True)

LIB_DIR = os.path.join(HERE, "lib")
sys.path.insert(0, LIB_DIR)

IN_FMRI_DRAWS = os.path.join(DERIV_DIR, "step19_ps_moderation", "step19_ps_fmri_posterior_draws.npz")
IN_VBM_DRAWS = os.path.join(DERIV_DIR, "step19_ps_moderation", "step19_ps_vbm_posterior_draws.npz")
...
OUT_FMRI_JN = os.path.join(STEP_DERIV_DIR, "step20_jn_ps_fmri_results.csv")
